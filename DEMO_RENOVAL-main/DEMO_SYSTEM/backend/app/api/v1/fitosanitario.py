...
@router.get("/certificados", response_model=List[CertificadoSchema], dependencies=[Depends(require_roles(Role.ADMIN, Role.OPERADOR, Role.ALMACENISTA, Role.CLIENTE, Role.PROVEEDOR))])
